...
## Project Structure
    ...
    ├── testapiautostoryboa_76746  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_76746`
...
2. Clone this repo and `cd testapiautostoryboa_76746`
